...
var FRAME = document.getElementsByName("center")[0].contentWindow.document;
...
function htmlTableToArray() {
  ...
  */
  ...
  var uselessTr = $("#id_divEncRep", FRAME);
  var mainTable = uselessTr.parent();

  uselessTr.remove();

  var rows = $(mainTable, FRAME).children();
...
function getAllCoursesNames() {
  ...
  var rawScheduleData = $("td", FRAME).filter("[align=left][valign=MIDDLE]");
